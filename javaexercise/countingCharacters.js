...
function countingCharacters2(stringToCount, characterToFind){
  ...
  console.log("Chracter to find: " + characterToFind);
...
function countingCharacters3(str, search){
  ...
  /* we need to tstop loop based on multiple characters example: if searching
     "Ohio" with 3 characters at a time we want to stop at h so we do not go
